...
//Toggle
$(function(){$("#firstPara, #secondPara, #thirdPara").hide();});
$(function(){$("#firstLine").click(function(){$(this).next().toggle("slow");});});
$(function(){$("#secondLine").click(function(){$(this).next().toggle("slow");});});
$(function(){$("#thirdLine").click(function(){$(this).next().toggle("slow");});});
*/